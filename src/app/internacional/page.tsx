...
export default async function InternacionalPage() {
  const news = await getNews('internacional');
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
      ...
      <section className="relative pt-20 pb-12 lg:pt-32 lg:pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm text-purple-800 text-sm font-medium mb-8 border border-purple-200/50 shadow-lg animate-bounce">
            <div className="w-2 h-2 bg-red-500 rounded-full mr-2 animate-pulse"></div>
            AO VIVO - Últimas notícias do futebol internacional
          </div>
          ...
          <p className="text-xl lg:text-2xl text-gray-600 max-w-4xl mx-auto mb-8 leading-relaxed">
            Acompanhe as principais notícias, transferências, resultados e análises do futebol internacional em tempo real
          </p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {news.length > 0 ? (
          ...
          <div className="text-center py-20">
            <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-8 animate-bounce">
              <span className="text-4xl">⚽</span>
            </div>
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Carregando notícias...</h3>
            <p className="text-lg text-gray-600 max-w-md mx-auto mb-8">
              Estamos buscando as últimas notícias do futebol internacional para você
            </p>
